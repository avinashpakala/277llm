...
async def main():
    ...
    st.title("You can ask anything about events")
    ...
    if st.session_state['ready']:
        ...
        if 'generated' not in st.session_state:
            st.session_state['generated'] = ["You can ask anything about events"]
        ...
        with container:
            with st.form(key='my_form', clear_on_submit=True):
                user_input = st.text_input("Query:", placeholder="e.g: Any upcoming events in San Jose", key='input')
